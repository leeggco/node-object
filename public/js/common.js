$(document).ready(function(){
  ...
  $('.book-del').click(function(){
    ...
    var thisParent = $(this).parentsUntil('tr');
    $.ajax({
      type: 'post',
      url: '/admin/AjaxBookDel',
      data: {'bid': bid, 'uid': uid, 'cid': cid},
      success: function(data){
        if(data.status === 'success'){
          thisParent.remove();
          showResText(data.status, data.resTxt);
  ...
  $('.emptyBook-del').click(function(){
    var bid = $(this).attr('data-bid');
    var cid = $(this).attr('data-cid');
    var thisParent = $(this).parent();
    $.ajax({
      type: 'post',
      url: '/admin/AjaxInvalidBookDel',
  ...
  $('.cateRename').click(function(){
    var $that = $(this);
    var val = $that.siblings('.cate-input').val();
    ...
    $.ajax({
      ...
      success: function(data){
        if(data.status === 'success'){
          $that.parent().hide();
          $that.parent().prev().find('.cateName').text(data.newVal);
          $that.parent().prev().find('.beRename').show();
          showResText(data.status, data.resTxt);
        }
      }
    })
  ...
  $('.cate-count .count').click(function(){
    $(this).nextAll('p').toggle();
  })
  
  $('.cateCancl').click(function(){
    $(this).parent().hide();
    $(this).parent().prev().find('.beRename').show();
  })
  
  $('.beRename').click(function(){
    $(this).hide();
